...
class FakeSettings(private val data: MutableMap<String, Any?> = mutableMapOf()) : Settings {
    ...
    override fun putBool(key: String, value: Boolean) { data[key] = value }
    override fun putShort(key: String, value: Short) { data[key] = value }
    ...
    override fun putInstant(key: String, value: Instant) { data[key] = value }
    override fun putLocalDate(key: String, value: LocalDate) { data[key] = value }
    override fun putLocalTime(key: String, value: LocalTime) { data[key] = value }
    override fun putLocalDateTime(key: String, value: LocalDateTime) { data[key] = value }
    override fun putUUID(key: String, value: Uuid) { data[key] = value }

    override fun putStringOrNull(key: String, value: String?) { data[key] = value }
    override fun putBoolOrNull(key: String, value: Boolean?) { data[key] = value }
    override fun putShortOrNull(key: String, value: Short?) { data[key] = value }
    override fun putIntOrNull(key: String, value: Int?) { data[key] = value }
    override fun putLongOrNull(key: String, value: Long?) { data[key] = value }
    override fun putFloatOrNull(key: String, value: Float?) { data[key] = value }
    override fun putDoubleOrNull(key: String, value: Double?) { data[key] = value }
    override fun putInstantOrNull(key: String, value: Instant?) { data[key] = value }
    override fun putLocalDateOrNull(key: String, value: LocalDate?) { data[key] = value }
    override fun putLocalTimeOrNull(key: String, value: LocalTime?) { data[key] = value }
    override fun putLocalDateTimeOrNull(key: String, value: LocalDateTime?) { data[key] = value }
    override fun putUUIDOrNull(key: String, value: Uuid?) { data[key] = value }
}
